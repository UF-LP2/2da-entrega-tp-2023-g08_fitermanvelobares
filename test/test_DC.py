...
def test_FilaDivideConquer():
    ...
    assert ListaNoAtentidos[2].Nombre == Sofia.Nombre
    assert ListaNoAtentidos[3].Nombre == Julio.Nombre 
    assert ListaNoAtentidos[4].Nombre == Malena.Nombre
    assert ListaNoAtentidos[5].Nombre == Pedro.Nombre
    ...
    assert ListaNoAtentidos[1].Nombre == Maria.Nombre
    assert ListaNoAtentidos[2].Nombre == Sofia.Nombre
    assert ListaNoAtentidos[3].Nombre == Jose.Nombre
    assert ListaNoAtentidos[4].Nombre == Julio.Nombre 
    assert ListaNoAtentidos[5].Nombre == Malena.Nombre
    assert ListaNoAtentidos[6].Nombre == Pedro.Nombre
